...
| Level | Event |
|-------|-------|
| 25 | First Ascendancy Trial - Choose your path |
| 50 | Second Trial - Gain second point |
...
*"The sort of hero who stands in front of danger not because they're brave, but because they're too stubborn to move."*
...
*"Firmly believes that the best defense is killing everything before it can hit you. The missing HP is just motivation."*
...
*"Why use one sword when you can look twice as impressive with two?"*
...
Rogues specialize in burst damage through different means.
...
Rangers have three distinct paths for different combat styles.
...
Mages choose between raw elemental power or dark magic.
...
Clerics choose between healing mastery or battle cleric.
...
## Necromancer Ascendancies

Necromancers focus on minions or personal dark power.
...
| Class | Ascendancy | Best For |
|-------|------------|----------|
| Warrior | Champion | New players, reliable tanking |
| Warrior | Berserker | Speed runs, high damage |
| Warrior | Gladiator | Crit builds, dual wielding |
...
- [Heroes & Classes](heroes.md) - Base class information
- [Combat System](combat.md) - How combat works
- [Equipment & Items](equipment.md) - Gearing for your build
