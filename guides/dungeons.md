...
Special missions marked with 🔓 unlock guild facilities:

| Mission | Unlocks |
|---------|---------|
| The Wandering Smith | Forge |
| Craftsman's Legacy | Workshop |
| Mysterious Ingredients | Alchemy Lab |
| Lost Tomes | Library |
| Arcane Secrets | Enchanting Table |
| A Priest's Prayer | Chapel |
...
Stars determine dungeon length and structure:

| Stars | Rooms | Floors | Duration | Boss? |
|-------|-------|--------|----------|-------|
| ⭐ | 4 | 1 | 1 day | No |
| ⭐⭐ | 7 | 1 | 2 days | No |
| ⭐⭐⭐ | 12 | 2 | 3 days | Yes |
...
Monster level determines enemy strength:
...
|------|------|-------------|
| **Entrance** | 🚪 | Starting point, safe |
| **Combat** | ⚔️ | Enemy encounter |
| **Treasure** | 💎 | Loot chest |
| **Trap** | ⚠️ | Trap encounter |
| **Rest** | 🏕️ | Safe zone, partial heal |
...
### Material Tiers by Dungeon

| Stars | Materials Available |
|-------|---------------------|
| ⭐-⭐⭐ | T1 Common, T2 Uncommon |
| ⭐⭐-⭐⭐⭐ | T1-T3 (Rare unlocks at L30+) |
| ⭐⭐⭐-⭐⭐⭐⭐ | T2-T4 (Epic unlocks at L50+) |
| ⭐⭐⭐⭐-⭐⭐⭐⭐⭐ | T3-T5 (Legendary at L70+) |

### Loot Quality Factors

| Factor | Bonus |
|--------|-------|
| Higher star rating | Better tier chance |
| Higher monster level | Better drops |
| Supervised expedition | +20% quality |
...
Crafting currencies (see [Crafting Guide — Currencies](crafting.md#crafting-currencies)) drop from dungeon completions. Regular dungeons yield Powders at ~10–15% per clear, Salt of Renewal at 3%, each Ichor at 2%, and Salt of Cleansing and the Portents at 0.8% — enough that mid-game players encounter the Workshop's advanced mechanics without needing endgame content. Heroic dungeons run roughly double on the Rare and Epic reagents and add the Cursed Sigil (1%). Difficulty gates the pool as well as the rate: Ichors need a ⭐⭐⭐ contract, Salt of Cleansing and the Portents ⭐⭐⭐⭐, and a one-star dungeon will hand you Powders until the stars go out.
...
| Result | Gold | XP | Rep |
|--------|------|-----|-----|
| Critical Success | 150% | 150% | 150% |
| Success | 100% | 100% | 100% |
| Partial Success | 50% | 70% | 50% |
| Failure | 0% | 30% | -30% |
...
- [Combat System](combat.md) - Fighting in dungeons
