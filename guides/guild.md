...
- **Fortune always adds at least +1 bonus item on cast** — the loot-count percentage scales on top of that guaranteed floor. On top of the item bonus, Fortune's rare-roll has a small chance to add a guaranteed top-tier drop *for the mission's tier*: a Rare-cap mission guarantees a Rare, a Legendary-cap mission guarantees a Legendary, a Mythic-cap mission guarantees a Mythic. The Chapel isn't going to summon a Legendary from a Rare-tier goblin cave — but it will make sure you go home with something worth the day's blessing.
